...
I like <a href="http://daringfireball.net/projects/markdown/syntax">Markdown</a> but in fact I don't use it very much. I always forget the syntax for links and images and find it a bit unclear on many cases.

At one point, I read about some <a href="http://practicaltypography.com/">practical typography advices</a> and it hardened a perspective whose germ was already there.

*from-plain-text* is my way of having some HTML code from plain text. I ditch almost everything from Markdown. In fact, there's only left the identification of headers and of paragraphs. Nothing else.

With Markdown, I found it way too easy to italicize words and too tempting to make a list (<a href="http://www.edwardtufte.com/tufte/books_pp">PowerPoint lurking!</a>). And too hard to do anything else.
...
On the client side, I'm relying on [React](http://facebook.github.io/react/index.html) because I have dwelt enough on intricate callbacks and html insertion with strings.
